...
export const DEFAULT_CONTENT = {
  ...
  about: {
    badge: 'ვინ ვართ ჩვენ',
    heading: 'ვაშენებთ გატაცებით და სიზუსტით',
    text1: 'AlBuild Group წარმოადგენს სამშენებლო კომპანიას, რომელიც მოღვაწეობს თბილისში და რომლის მთავარი მიზანია პროექტების მაღალი ხარისხითა და პროფესიონალური სტანდარტებით განხორციელება.',
    ...
    items: [
      {
        ...
        features: ['საძირკვლის სამუშაოები', 'ბლოკური და ინდივიდუალური სახლების მშენებლობა', 'ურბანული და სოფლის პროექტები', 'მაღალი ხარისხის სამშენებლო მასალები', 'სტანდარტებისა და უსაფრთხოების სრული დაცვა', 'კარკასული მშენებლობა', 'ფასადისა და ინტერიერის სამუშაოები', 'ინჟინრული სისტემები', 'ხარისხის კონტროლი'],
  ...
  footer: {
    tagline: 'ვაშენებთ მტკიცე და საიმედო ნაგებობებს 2010 წლიდან. თქვენი სანდო პარტნიორი ყველა სამშენებლო პროექტში.',
