...
const trust = [
  { Icon: ShieldIcon, text: 'ISO 9001 სერტიფიცირებული' },
    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto pt-28 pb-52">
        ...
        <p className="text-base sm:text-lg text-[#f5e6d3]/55 mb-10 max-w-xl mx-auto leading-relaxed">
          2010 წლიდან ვქმნით გამძლე, ლამაზ და ინოვაციურ სამშენებლო გადაწყვეტებს — საცხოვრებელი სახლებიდან დაწყებული მსხვილ კომერციულ კომპლექსებამდე.
        </p>
